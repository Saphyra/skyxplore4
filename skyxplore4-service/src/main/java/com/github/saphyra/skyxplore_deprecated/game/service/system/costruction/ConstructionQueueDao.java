...
import com.github.saphyra.skyxplore_deprecated.game.service.queue.QueueItemDao;
...
public class ConstructionQueueDao implements QueueItemDao {
    ...
    public void cancel(UUID starId, UUID queueItemId, QueueType queueType) {
        ...
        reservationCommandService.deleteByExternalReferenceAndPlayerId(construction.getConstructionId());
    }
}
