package com.github.saphyra.skyxplore_deprecated.game.service.map.surface.terraform;

import com.github.saphyra.skyxplore_deprecated.common.ExceptionFactory;
import com.github.saphyra.skyxplore_deprecated.data.gamedata.domain.terraforming.TerraformingPossibilitiesService;
import com.github.saphyra.skyxplore_deprecated.data.gamedata.domain.terraforming.TerraformingPossibility;
...
import com.github.saphyra.skyxplore_deprecated.game.service.ResearchRequirementChecker;
import com.github.saphyra.skyxplore_deprecated.game.service.system.costruction.ConstructionService;
import com.github.saphyra.skyxplore_deprecated.game.service.system.storage.ResourceReservationService;
...
public class TerraformSurfaceService {
    ...
    private void verifyTerraformAvailable(Surface surface, SurfaceType surfaceType, List<String> researchRequirements) {
        ...
        if (constructionQueryService.findByConstructionTypeAndSurfaceIdAndPlayerId(ConstructionType.BUILDING, surface.getSurfaceId()).isPresent()) {
