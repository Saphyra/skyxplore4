...
public class ResourceReservationService {
    ...
    private void reserveResource(Surface surface, Map.Entry<String, Integer> resourceEntry, ReservationType reservationType, UUID externalReference) {
        ...
        if (available > 0) {
            ...
            allocationService.allocate(surface.getGameId(), surface.getUserId(), surface.getStarId(), externalReference, resourceData, toAllocate, AllocationType.CONSTRUCTION, surface.getPlayerId());
